...
<%@ page import = "com.gec.it.bean.TypeBean,com.gec.it.dao.AdminDao,com.gec.it.dao.TypeDao,com.gec.it.bean.BookBean,com.gec.it.dao.BookDao,com.gec.it.bean.AdminBean" %>
                               ...
                               <form class="form-horizontal" method="post" action="updateBookServlet">   <!--保证样式水平不混乱-->
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">
											<label for="updateBookId" class="col-sm-3 control-label">图书号</label>
												<div class="col-sm-7">
...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
										...
										<div class="form-group">	
											<label for="updateAutho" class="col-sm-3 control-label">作者名称</label>
												<div class="col-sm-7">
										...
										<div class="form-group">	
											<label for="updateNum" class="col-sm-3 control-label">总数量</label>
												<div class="col-sm-7">
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>
										...
										<div class="form-group">	
											<label for="addNum" class="col-sm-3 control-label">总数量</label>
												<div class="col-sm-7">
